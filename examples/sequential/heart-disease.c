...
int main(void)
{
    ...
    cml_matrix *x = cml_matrix_zeros(303, 13);
    cml_matrix *y = cml_matrix_zeros(303, 5);
    const char *file_path = "data/processed.cleveland.data";
    ...
    const fdouble alpha = 5E-05;
    const lgint epochs = 20000;
